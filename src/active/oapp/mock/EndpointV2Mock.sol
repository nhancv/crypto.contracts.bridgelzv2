...
// https://www.npmjs.com/package/@layerzerolabs/test-devtools-evm-hardhat?activeTab=code
/* solhint-disable */
...
contract EndpointV2Mock is ILayerZeroEndpointV2, MessagingContext {
  ...
  function receivePayload(
    ...
    if (_msgValue > 0) {
      try
        ILayerZeroReceiver(_receiver).lzReceive{ value: _msgValue, gas: _gas }(_origin, _guid, _message, address(0), "")
